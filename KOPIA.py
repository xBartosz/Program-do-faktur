...
class App():
    ...
    def logowanie(self):
        ...
        if entered_login and entered_password != "":
            connection = mysql.connector.connect(user="root", password="", host="localhost", database="accounts")
    ...
    def additem(self):
        ...
        #kategorie
        categories = ["Biżuteria", "Broń", "Kosmetyki", "Meble", "Narzędzia", "Sprzęt RTV", "Odzież"]
